...
class DeleteBookingsViewer
{
    ...
    private function makeRequestsHTML($request_element_id,$booking){
        ...
        for($i = 0; $i < count($requests); $i++){
            $request = $requests[$i];
            $html .= "<div  class='card'>";
            $html .= "<div class='card bg-info text-primary'>";
